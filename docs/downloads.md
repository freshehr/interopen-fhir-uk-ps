# Downloads - UK Patient Summary Implementation Guide v0.1.0-cibuild
...
All the profile information for the UK Patient Summary Implementation Guide in a single CSV or Excel file, which may be helpful to testers and analysts to review element properties across profiles in a single table:
