...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile UKCoreComposition
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Composition">
      <sch:assert test="count(f:extension[@url = 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-CareSettingType']) &lt;= 1">extension with URL = 'https://fhir.hl7.org.uk/StructureDefinition/Extension-UKCore-CareSettingType': maximum cardinality of 'extension' is 1</sch:assert>
